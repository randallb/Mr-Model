...
# Plural allows someone to use an inflection lib of their choice.
  #name: "mrmodel"
  #plural: 
# Routes is where we define the custom routes for the module. We use the name
...
# Methods conforming to the connect middleware standard
  ...
  @routes:
    "/":
      get: [@middleware.logger, fox.middleware, (req, res, next) =>
        @methods.logger()
...
# We export out the class "naked" so MrMVC can parse it.
